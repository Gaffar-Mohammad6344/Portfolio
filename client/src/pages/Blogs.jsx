...
//   return (
//     <section className="relative min-h-screen pt-36 pb-24 overflow-hidden selection:bg-red-500/30">
//       {/* --- PREMIUM BACKGROUND ELEMENTS --- */}
//       {/* 1. Subtle Grid Pattern */}
//       <div className="absolute inset-0 z-0 opacity-[0.03] dark:opacity-[0.05] pointer-events-none" 
//            style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3 guest%3Cpath d='M54 48L54 12' fill='none' stroke='%23ff0000' stroke-width='1'/%3E%3C/svg%3E")` }} 
//       />
...
//       <div className="absolute right-[-5%] top-[20%] h-[400px] w-[400px] rounded-full bg-blue-600/5 blur-[120px] pointer-events-none" />
//       <div className="absolute left-[20%] bottom-[-10%] h-[400px] w-[400px] rounded-full bg-red-500/10 blur-[100px] pointer-events-none" />
...
//             className="mx-auto mt-6 max-w-2xl text-lg text-slate-500 dark:text-slate-400 font-medium leading-relaxed"
//           >
//             Exploring the intersection of <span className="text-red-500/80">AI</span>, 
//             <span className="dark:text-white text-slate-900"> Software Architecture</span>, and 
...
//         >
//           <div className={`group relative p-1 rounded-2xl transition-all duration-500 ${isFocused ? 'bg-gradient-to-r from-red-500/50 to-red-800/50 shadow-[0_0_30px_rgba(239,68,68,0.2)]' : 'bg-transparent'}`}>
//             <div className="relative flex items-center bg-white dark:bg-[#0B0F1A] rounded-[14px] overflow-hidden border border-black/5 dark:border-white/5 shadow-2xl">
//               <div className="pl-6 text-slate-400 group-hover:text-red-500 transition-colors duration-300">
//                 <FiSearch size={24} />
//               </div>
//               <input
//                 type="text"
...
//                 className="w-full bg-transparent py-6 px-6 text-lg outline-none placeholder:text-slate-500 font-medium"
//                 style={{ color: "var(--text-primary)" }}
//               />
//               <div className="pr-6 hidden md:flex items-center gap-2">
//                 <span className="px-2 py-1 rounded-md bg-slate-100 dark:bg-white/5 border border-black/10 dark:border-white/10 text-[10px] text-slate-400 font-bold">ESC</span>
//               </div>
//             </div>
//           </div>

//           {/* Quick Filters / Stats */}
//           <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm font-bold uppercase tracking-widest text-slate-400">
//             <div className="flex items-center gap-2">
//               <FiTrendingUp className="text-red-500" />
//               <span>{filteredBlogs.length} Articles Found</span>
//             </div>
//             <div className="h-1 w-1 rounded-full bg-slate-700 hidden md:block" />
...
//       // DEBUG: This will show in your console to confirm mapping is happening
...
//       initial={{ opacity: 0 }}
//       animate={{ opacity: 1 }}
//       className="col-span-full py-32 flex flex-col items-center justify-center text-center border border-dashed border-white/10 rounded-3xl bg-white/5 backdrop-blur-sm"
//     >
...
//       <button 
//         onClick={() => setSearch("")}
//         className="mt-8 px-6 py-2 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl transition-all"
//       >
//         Clear Search
//       </button>
//     </motion.div>
